import { c as create_ssr_component, a as subscribe, g as getContext, v as validate_component, d as add_attribute, f as each } from "../../../chunks/index2.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Transition, "Transition").$$render($$result, {}, {}, {
      default: () => {
        return `<div${add_attribute("class", clsx("w-full text-green px-10"), 0)}>
