<script>
	...
	$: {
		...
		if (isOption === 3) options = options3;
		if (isOption === 4) options = options4;
		if (isOption === 5) options = options5;
...
<style>
	.result {
		background: rgba(224, 231, 241, 0.02);
		box-shadow: 0px 0px 4px 3px rgba(255, 255, 255, 0.05);
	}
</style>
